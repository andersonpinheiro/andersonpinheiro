...
💼 Trabalho nos **Correios desde 2012**, hoje como **Assistente Comercial**.

🎓 **Formação:**
- Bacharel em **Sistemas de Informação** (2013)  
- Pós-graduação em **Metaverso, Cloud e IoT: Novas Tecnologias de Informação e Comunicação**  
- Pós-graduação em **E-Commerce: Planejamento e Gestão de Comércio Eletrônico**  
- Estudante de **Desenvolvimento de Software Multiplataforma (DSM)** — FATEC  

🤖 Apaixonado por **Inteligência Artificial** e tecnologias emergentes.
...
### 🔹 **Innovare Contábil PF**
Site institucional profissional  
👉 https://innovarecontabilpf.com.br
...
Curto conversar sobre tecnologia, IA, desenvolvimento web e inovação — me chame quando quiser!
